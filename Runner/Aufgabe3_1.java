...
public class Aufgabe3_1 {
    public static void main(String[] args) throws InterruptedException {
        ...
        // create Neurons
        Neuron endingNeuron = network.addEndingNeuron(in -> new NetEntries.andGate().evaluate(in), (in1, in2, in3) -> new ActivationFunctions.identityNetEntry().evaluate(in1, in2, in3),
